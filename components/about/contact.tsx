    ...
    <div className='w-[300px] md:w-[400px] xl:w-[807px] h-[170px] text-white rounded-xl p-[2px] bg-gradient-to-r from-[#6971A2]/16 to-[#272A3C]/37 mx-auto overflow-hidden transition-all'>
      <div className='w-full h-full bg-[#07091F] overflow-hidden relative rounded-xl'>
        <div className='w-full h-full'>
            ...
            <h2 className='text-xl xl:text-3xl font-bold w-5/6 mx-auto text-center py-6'>Lets <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">create</span> something <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">together</span> !</h2>
            <CopyMail />
        </div>
      </div>
    </div>
