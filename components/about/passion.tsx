    ...
    <Card>
        ...
        <div className='w-full h-full px-4 py-6'>
          <h2 className='text-xl font-bold'>
            Passionate about <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">tech</span> and 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]"> development</span>
          </h2>
