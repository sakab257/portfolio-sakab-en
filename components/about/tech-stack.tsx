...
const techLeft = ["Python","NextJS","PHP","Swift"]
    ...
    <Card>
        ...
        <div className='w-full h-full grid grid-cols-2 pl-4 pr-2'>
            <div className='w-full h-full flex flex-col justify-center items-center'>
                <p className='text-[10px] md:text-xs'>Continuously improving my</p>
                <h2 className='text-3xl md:text-4xl font-black'>Stack</h2>
            </div>
