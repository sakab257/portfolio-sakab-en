...
export default function Home() {
  return (
    <div className="h-full w-full flex flex-col items-center gap-6">
      ...
      <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold text-center w-[300px] md:w-[400px] xl:w-[800px]">
        Full-Stack <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">Developer</span> passionate about <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">Generative AI</span> and <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#CBACF9] to-[#D4B7FF]">Information Systems Architecture</span>
      </h1>
      <Button label="Who did I work with ?" />
